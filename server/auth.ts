...
import {
    sendWelcomeEmail,
    logWelcomeEmail,
} from "./jobs/checkoutRecoveryScheduler";
...
export async function setupAuth(app: Express) {
    ...
    app.get("/api/auth/verify-email", async (req, res) => {
        ...
        try {
            ...
            sendWelcomeEmail(user.email!, user.firstName, user.emailLanguage)
                .then(() => logWelcomeEmail(user.id))
                .catch((err: any) => console.error("[WelcomeEmail] Failed:", err?.message || err));
